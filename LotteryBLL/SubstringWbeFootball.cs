...
{
    public class SubstringWbeFootball
    {
        ...
        public string SubstringHTML_Div(string string_html, List<string> strnumber, string PlayID)
        {
            ...
            for (int i = 0; i < strnumber.Count; i++)
            {
                ...
                str_html = Regex.Match(string_html, "(pname=\"" + strArray[0] + "\" pdate=\"" + strArray[1] + "\"(.+?)<tr zid=\"\\d+\" mid=\"\\d+\" pname=\"\\d+\")").Groups[0].Value.ToString();
        ...
        private string PlayGameSP(string PlayID, string[] PlayType, string str_html)
        {
            ...
            switch (PlayID)
            {
                case "9001": ss = Get_9001(PlayType, str_html); break;
                case "9002": ss = Get_9002(PlayType, str_html); break;
                case "9003": ss = Get_9003(PlayType, str_html); break;
                case "9004": ss = Get_9004(PlayType, str_html); break;
                //case "9005": ss = Get_9005(PlayType, str_html); break;
                case "9006": ss = Get_9006(PlayType, str_html); break;
                default: break;
            }
            return ss;
        }
        ...
        private string Get_9001(string[] PlayType, string str_html)
        {
            List<string> str = new List<string>();
            ...
            string playStr = Regex.Match(str_html, "<!--让球胜平负-->(.+)<!--比分-->").Value;
        ...
        public string SelectUrl(string PlayID, string Number_Str)
        {
            ...
            theStr = "http://trade.500.com/jczq/index.php?playid=312";//500万彩票网
